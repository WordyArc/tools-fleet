...
Press <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>F2</kbd> (<kbd>Cmd</kbd>+<kbd>Opt</kbd>+<kbd>F2</kbd> on macOS), then type
to filter tool windows by name. The list separates visible, previously opened and unopened tool windows, and each
row shows the tool window's own IDE shortcut when it has one.
...
| Key                                          | Action                                                           |
|----------------------------------------------|------------------------------------------------------------------|
| <kbd>Ctrl</kbd>+<kbd>Alt</kbd>+<kbd>F2</kbd> | Open or close Tool Finder                                        |
...
On macOS, the default shortcut is <kbd>Cmd</kbd>+<kbd>Opt</kbd>+<kbd>F2</kbd>.
